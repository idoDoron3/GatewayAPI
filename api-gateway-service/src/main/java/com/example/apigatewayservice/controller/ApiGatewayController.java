...
public class ApiGatewayController {
    ...
    @GetMapping("/article/{id}/metadata")
    ...
    public ResponseEntity<String> getWordMappings(@PathVariable String word) {
        try {
            String sanitizedWord = apiGatewayService.sanitizeWord(word);
            ResponseEntity<String> response = apiGatewayService.getWordMappings(sanitizedWord);
